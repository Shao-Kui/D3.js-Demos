...
// var worldId = {'韩国':1,'日本':​2,'意大利':​3,'伊朗':​4,'新加坡':​5,'美国':​6,'德国':​7,'法国':​8,'科威特':​9,'泰国':​10,'西班牙':​11,'巴林':​12,'澳大利亚':​13,'马来西亚':​14,'英国':​15,'阿联酋':​16,'越南':​17,'加拿大':​18,'瑞士':​19,'瑞典':​20,'以色列':​21,'伊拉克':​22,'阿曼':​23,'奥地利':​24,'俄罗斯':​25,'克罗地亚':​26,'挪威':​2,'希腊':​28,'菲律宾':​29,'芬兰':​30,'黎巴嫩':​31,'罗马尼亚':​32,'印度':​33,'巴基斯坦':​34,'丹麦':​35,'格鲁吉亚':​36,'荷兰':​37,'墨西哥':​38,'阿尔及利亚':​39,'阿富汗':​40,'阿塞拜疆':​41,'爱沙尼亚':​42,'巴西':​43,'白俄罗斯':​44,'北马其顿':​45,'比利时':​46,'冰岛':​4,'柬埔寨':​48,'立陶宛':​49,'摩纳哥':​50,'尼泊尔':​51,'尼日尼亚':​52,'斯里兰卡':​53,'新西兰':54}

// "泰国"​,"西班牙"​,"巴林"​,"澳大利亚"​,"马来西亚"​,"英国"​,"阿联酋"​,"越南"​,"加拿大"​,"瑞士"​,"瑞典"​,"以色列"​,"伊拉克"​,"阿曼"​,"奥地利"​,"俄罗斯"​,"克罗地亚"​,"挪威"​,"希腊"​,"菲律宾"​,"芬兰"​,"黎巴嫩"​,"罗马尼亚"​,"印度"​,"巴基斯坦"​,"丹麦"​,"格鲁吉亚"​,"荷兰"​,"墨西哥"​,"阿尔及利亚"​,"阿富汗"​,"阿塞拜疆"​,"爱沙尼亚"​,"巴西"​,"白俄罗斯"​,"北马其顿"​,"比利时"​,"冰岛"​,"柬埔寨"​,"立陶宛"​,"摩纳哥"​,"尼泊尔"​,"尼日尼亚"​,"斯里兰卡"​,"新西兰"];
...
const setting_up_barchart = function(data){
    ...
    barScale = d3.scaleLinear()
            ...
            .range([0, 200]);
    console.log(worldId[0], worldId[0] === '韩国', '....');
    let c = 0; 
    let intervalId = setInterval(function(){
        if(c >= alldates.length){
            ...
            console.log(data_today.map( (datum) => {return datum['国家']; } ))
